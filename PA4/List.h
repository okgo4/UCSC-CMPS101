...
void insertBefore(List L, Node N, int data); // Insert a new Node into Node Ni%f* list
...
void insertAfter(List L, Node N, int data); // Insert a new Node into Node Ni%f* list
...
// Node N link to the Node thati%f* after Node N as its
// next Node, and making the Node after Node N link to
// the Node thati%f* before Node N as its previous Node.
//
