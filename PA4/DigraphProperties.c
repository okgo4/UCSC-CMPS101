...
int main(int argc, char **argv) {
   if (argc != 3) {
    ...
    while(fgets(buffer,n,in)!=NULL) {
		...
		else if(strcmp(buffer,"GetCountSCC\n")==0)
		{
			fprintf(out,"%d\n",getCountSCC(g));
		}
		else
		{
	        ...
	        else if(strcmp(parts[0],"GetNumSCCVertices")==0)
	        {
	            if(sume!=1)
	            {
	                fprintf(out,"ERROR\n");
	        ...
	        //////////////////////////////////////
	        else if(strcmp(parts[0],"InSameSCC")==0)
	        {
	            if(sume!=2)
	            {
	                fprintf(out,"ERROR\n");
